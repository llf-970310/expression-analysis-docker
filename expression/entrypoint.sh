...
celery worker -P gevent -A celery_tasks.app -n %h_Qt-Pre_p1 -Q q_pre_test -l info -c 20 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-12_p1 -Q q_type12 -l info -c 12 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-12_p2 -Q q_type12 -l info -c 13 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-3_p1 -Q q_type3 -l info -c 12 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-3_p2 -Q q_type3 -l info -c 13
