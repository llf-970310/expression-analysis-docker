...
celery worker -P gevent -A celery_tasks.app -n Qtype3_worker1@%h -Q for_q_type3 -l info -c 10 &
celery worker -P gevent -A celery_tasks.app -n Qtype3_worker2@%h -Q for_q_type3 -l info -c 10 &
celery worker -P gevent -A celery_tasks.app -n Qtype3_worker3@%h -Q for_q_type3 -l info -c 10 &
celery worker -P gevent -A celery_tasks.app -n Qtype12_worker1@%h -Q for_q_type12 -l info -c 10 &
celery worker -P gevent -A celery_tasks.app -n Qtype12_worker2@%h -Q for_q_type12 -l info -c 10 &
celery worker -P gevent -A celery_tasks.app -n Qtype12_worker3@%h -Q for_q_type12 -l info -c 10
