...
celery worker -P gevent -A celery_tasks.app -n %h_Qt-12_p1 -Q q_type12 -l info -c 15 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-12_p2 -Q q_type12 -l info -c 15 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-3_p1 -Q q_type3 -l info -c 15 &
celery worker -P gevent -A celery_tasks.app -n %h_Qt-3_p2 -Q q_type3 -l info -c 15
