...
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p1" -Q q_type3 -l info -c 5 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p2" -Q q_type3 -l info -c 5 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p3" -Q q_type3 -l info -c 5
