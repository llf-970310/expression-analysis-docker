...
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p1" -Q q_type3 -l info -c 4 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p2" -Q q_type3 -l info -c 4 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p3" -Q q_type3 -l info -c 4 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p4" -Q q_type3 -l info -c 4 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p5" -Q q_type3 -l info -c 4 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p6" -Q q_type3 -l info -c 4 &
celery worker -P gevent -A celery_tasks.app -n $this_ip"-Qt-3_p7" -Q q_type3 -l info -c 6
