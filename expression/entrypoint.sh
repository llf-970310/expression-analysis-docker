...
celery worker -P thread -A celery_tasks.app -n $this_ip"-Qt-3_p1" -Q q_type3 -l info -c 8 &
celery worker -P thread -A celery_tasks.app -n $this_ip"-Qt-3_p2" -Q q_type3 -l info -c 8 &
celery worker -P thread -A celery_tasks.app -n $this_ip"-Qt-3_p3" -Q q_type3 -l info -c 8 &
celery worker -P thread -A celery_tasks.app -n $this_ip"-Qt-3_p4" -Q q_type3 -l info -c 8
